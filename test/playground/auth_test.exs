defmodule Playground.AuthTest do
  ...
  describe "users" do
    ...
    test "create_user/1 with valid data creates a user" do
      valid_attrs = %{username: "some username", provider: "some provider", email: "some email", avatar_url: "some avatar_url"}
    ...
    test "update_user/2 with valid data updates the user" do
      user = user_fixture()
      update_attrs = %{username: "some updated username", provider: "some updated provider", email: "some updated email", avatar_url: "some updated avatar_url"}
